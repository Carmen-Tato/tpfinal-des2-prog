...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        lang: { // Variables de idioma
            cartTitle: "Carrito de Compras",
            checkout: "Finalizar Compra",
            clear: "Limpiar",
            subtotal: "Subtotal:",
            cartRemove: "×",
            cartEmpty: "¡El carrito está vacío!<br />Elige tus productos"
        },
            ...
            if (this.options.toolbarSettings.showCheckoutButton) {
                ...
                switch (this.options.toolbarSettings.checkoutButtonStyle) {
                    ...
                    case 'image':
                        ...
                        break;
                    default:
                        btnCheckout = '<button class="btn btn-dark sc-cart-checkout" type="buttont">' + this.options.lang.checkout + '</button> ';
                        break;
                }
